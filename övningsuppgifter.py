...
print (x)
print(x.capitalize()) # CP first and last
print(x.upper()) # Skriv ord i STOR BOKSTAV
print(x.lower()) # skriver ord i liten bokstav
print("-"+x.rjust(30)+"-")
print("-"+x.center(30)+"-")
print(x.strip()) # strip tar bort mellanslag
'''

'''Nr 42
Skriv ett program som frågar efter en sträng (Exempel ”banan”) . Programmet ska sedan
skriva ut hur många tecken som strängen bestod av 
F=input( " skriv en text: ")
print(F)
...
'''nr 43 
43. Skriv ett program innehållande en funktion som tar en text och returnerar samma text
baklänges. Exempel: givet strängen ”banan” returnerar programmet ”nanab” . Programmet
ska sedan fråga efter en sträng och sedan genom att anropa funktionen skriva ut texten
baklänges
Funktionen:
def gröda(v): 
    print(v + "kannel")
...
'''44.Skriv ett program som först frågar efter förnamn och sedan efternamn.
Programmet ska sedan skriva ut hela namnet (första bokstaven ska vara stor, som alltid i
namn…) och berätta vad namnet blir baklänges.'''
